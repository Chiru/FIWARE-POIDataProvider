FIWARE POI Mapper                  2014-09-19                      mjl

This package contains two HTML pages:
    index.xhtml    displays POIs on map
    edit_poi.html  displays POIs on map and allows editing of poi data
Except for editing the functionality is the same in both files.
